...
export default function Home() {
  ...
  return (
    <section className="relative overflow-hidden py-32 min-h-[100dvh] flex items-center justify-center">
      <div className="absolute inset-x-0 top-0 flex h-full w-full items-center justify-center bg-dotted-pattern opacity-100 [mask-image:linear-gradient(to_bottom,transparent_5%,white_100%)]">
      </div>
