...
export default function Home() {
  ...
  return (
    <section className="relative overflow-hidden py-32 min-h-[100dvh] flex items-center justify-center bg-[linear-gradient(to_bottom,var(--background)_25%,var(--secondary)_100%)]">
